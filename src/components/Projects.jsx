    ...
    return (
        <Box className="projectssection" sx={{ margin: 10 }} id="projects">
            ...
            >
                ...
                <ProjectCard image={agario} title="Agar.io Recreated" skills={["Java", "AI", "OOP"]} description="A Java-based game crafted utilizing object-oriented programming, where players manipulate circles with the objective of growing in size by devouring smaller circles. The design intricacies extended to the implementation of artificial intelligence for the game's bots. In this system, larger circles were programmed to chase the nearest smaller circles, while the smaller circles were endowed with the ability to actively dodge and evade their larger counterparts. Their movements were also provided with 'vision' to detect the nearest circle in their vicinity." />
